let picuresDescriptions = [
    ...
    '',
    'Графический концепт на тему "достижение цели". Голубым цветом обозначил ЦЕЛЬ. Каждая маленкая цель - часть большой, как пазл, который нужно собирать по кусочкам. Красным цветом обосначены "дурные" мысли, которые мешают работать.',
